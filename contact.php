         ...
         <div class="outer">
            ...
            <div class="mainbar">
				...
				<div class="inner-page">
					...
					<div class="inner-page-content team">
						<div class="team-inner">
							<div class="container">
								<!-- Header heading -->
								<h3 class="head"><i class="icon-group red"></i> Team Member</h3>
								<!-- Team member block -->
									...
									<div class="row">
										<div class="col-md-4">
											...
											<div class="member-info">
												<img src="img/team-user2.jpg" class="img-responsive" alt="" />
												<!-- Member details member-caption -->
												<div class="member-caption">
													<!-- Heading "Name" -->
													<h3><a href="#">Lestias Ceturi</a></h3>
													<span>CEO of company</span>
													<p> similique sunt in culpa qui officia deserunt mollitist laborum et distinctio.</p>
													<!-- Social Icons -->
													<div class="social">
										...
										<div class="col-md-4">
											<!-- team member info -->
											<div class="member-info">
												<img src="img/team-user1.jpg" class="img-responsive" alt="" />
												<!-- Member details member-caption -->
												<div class="member-caption">
													<!-- Heading "Name" -->
													<h3><a href="#">Dolore Meum</a></h3>
													<span>MD of company</span>
													<p> similique sunt in culpa qui officia deserunt mollitist laborum et distinctio.</p>
													<!-- Social Icons -->
													<div class="social">
														<a href="#" class="facebook"><i class="icon-facebook"></i></a>
										...
										<div class="col-md-4">
											<!-- team member info -->
											<div class="member-info">
												<img src="img/team-user3.jpg" class="img-responsive" alt="" />
												<!-- Member details member-caption -->
												<div class="member-caption">
													<!-- Heading "Name" -->
													<h3><a href="#">Maiores Alias</a></h3>
													<span>CA of company</span>
													<p> similique sunt in culpa qui officia deserunt mollitist laborum et distinctio.</p>
													<!-- Social Icons -->
													<div class="social">
														<a href="#" class="facebook"><i class="icon-facebook"></i></a>
